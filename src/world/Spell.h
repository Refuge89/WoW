...
ASCENT_INLINE bool IsCastedOnFriends(SpellEntry *sp)
{
...
ASCENT_INLINE bool IsCastedOnEnemies(SpellEntry *sp)
{
	for( int frloop = 0; frloop < 3; frloop++ )
	{
		switch (sp->EffectImplicitTargetA[frloop])
...
#define POWER_TYPE_HEAT 101
#define POWER_TYPE_OOZE 121
#define POWER_TYPE_BLOOD 141
#define POWER_TYPE_WRATH 142
...
/*        switch(m_spellInfo->NameHash)
	...
	ASCENT_INLINE static bool HasMechanic(SpellEntry * sp, uint32 MechanicsType)
	{
