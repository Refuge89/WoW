...
const char * gCreatureProtoFormat						= "uuuuuuufuuuffuffuuuuuuuuuuuffsuibuufffuuuuuuuuuuuuic";
...
void ObjectMgr::LoadExtraItemStuff()
{
	...
	//	gtr->Get()->gossip_script = sScriptMgr.GetDefaultGossipScript();
		gtr->Inc();
	}
	gtr->Destruct();
	...
	//	if (pItemPrototype->ItemId == 40732)
	//	sScriptMgr.GetDefaultGossipScript();
	//	pItemPrototype->gossip_script == sScriptMgr.GetDefaultGossipScript();
...
void ObjectMgr::LoadExtraGameObjectStuff()
{
	...
	//	goi->InvolvedQuestCount =0;
	//	goi->InvolvedQuestIds = NULL;

	//	goi->gossip_script = sScriptMgr.GetDefaultGossipScript();
