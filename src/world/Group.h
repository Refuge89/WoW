...
public:
	...
	ASCENT_INLINE void SetDifficulty(uint8 newDifficulty) { m_difficulty = newDifficulty; };
	ASCENT_INLINE void SetRaidDifficulty(uint8 newDifficulty) { m_raidDifficulty = newDifficulty; };
