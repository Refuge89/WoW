...
public:
	...
	void ASCENT_FASTCALL OutPacket(uint16 opcode, size_t len, const void* data);
	OUTPACKET_RESULT ASCENT_FASTCALL _OutPacket(uint16 opcode, size_t len, const void* data);
	...
	void ASCENT_FASTCALL UpdateQueuePosition(uint32 Position);
