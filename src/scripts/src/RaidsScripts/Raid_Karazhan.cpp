...
public:
	...
	void BarnesSpeakWOZ()
	{
		...
		// Timed text 1
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage,(uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "Tonight, we plumb the depths of the human soul as we join a lost, lonely girl trying desperately, with the help of her loyal companions, to find her way home.", EVENT_UNIT_CHAT_MSG, 7000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
		...
		// Timed text 2
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage,(uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "But she is pursued by a wicked, malevolent crone!", EVENT_UNIT_CHAT_MSG, 23000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
		...
		// Timed text 3
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage,(uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "Will she survive? Will she prevail? Only time will tell. And now: On with the show!", EVENT_UNIT_CHAT_MSG, 32000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
	...
	void BarnesSpeakRJ()
	{
		...
		_unit->PlaySoundToSet(9175);
		// Timed text 1
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage,(uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "Tonight we explore a tale of forbidden love!", EVENT_UNIT_CHAT_MSG, 6000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
		...
		// Timed text 2
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "But beware, for not all love stories end happily. As you may find out, sometimes love pricks like a thorn.", EVENT_UNIT_CHAT_MSG, 19300, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
		...
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage,(uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "But don't take it from me. See for yourself what tragedy lies ahead when the paths of star-crossed lovers meet. And now: On with the show!", EVENT_UNIT_CHAT_MSG, 32000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
	...
	void BarnesSpeakRed()
	{
		...
		_unit->PlaySoundToSet(9175);
		// Timed text 1
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "Tonight things are not what they seems for tonight your eyes may not be trusted.", EVENT_UNIT_CHAT_MSG, 7000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
		...
		// Timed text 2
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "Take for instance this quiet elderly woman waiting for a visit from her granddaughter. Surely there is nothing to fear from this sweet gray-haired old lady.", EVENT_UNIT_CHAT_MSG, 17000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
		...
		// Timed text 3
		sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "But don't let me pull the wool over your eyes. See for yourself what lies beneath those covers. And now: On with the show!", EVENT_UNIT_CHAT_MSG, 32000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
