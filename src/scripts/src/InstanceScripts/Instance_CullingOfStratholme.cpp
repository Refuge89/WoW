...
public:
	...
	void OnDamageTaken(Unit* mAttacker, float fAmount)
	{
		...
		{//lala
			...
			RemoveAIUpdateEvent();
			_unit->SendChatMessage( CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Your journey has just begun, young prince. Gather your forces, and meet me in the ARCEMU_ land of Northrend. It is there we shall settle the score between us. It is there that your true destiny will unfold.");
	...
	void OnReachWP(uint32 i, bool usl)
	{
		if( i == 3 && check )
		{
			...
			if( Arthas && Jaina )//Show must go on!
			{
				...
				//2 = 2,5s
				sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "Watch your tone with me, boy. You may be the prince, but I'm still your superior as a paladin.", EVENT_UNIT_CHAT_MSG , 2500, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//3 = 9s
				sEventMgr.AddEvent(TO_UNIT(Arthas), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "As if I could forget. Listen Uther, there's something about the plague you should know.", EVENT_UNIT_CHAT_MSG , 9000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//4 = 14,5s
				sEventMgr.AddEvent(TO_UNIT(Arthas), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "Oh no, it's already begun. These people may look fine now, but it's only a matter of time before they turn into the Undead!", EVENT_UNIT_CHAT_MSG , 14500, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//5 = 25s
				sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "What?!", EVENT_UNIT_CHAT_MSG , 25000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//6 = 26,5s
				sEventMgr.AddEvent(TO_UNIT(Arthas), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "This entire city must be purged.", EVENT_UNIT_CHAT_MSG , 26500, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//7 = 29s
				sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "How can you even consider that? There's *got* to be some other way.", EVENT_UNIT_CHAT_MSG , 29000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//8 = 33,5s
				sEventMgr.AddEvent(TO_UNIT(Arthas), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "Damn it, Uther! As your future king, I order you to purge this city!", EVENT_UNIT_CHAT_MSG , 33500, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//9 = 38s
				sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "You are *not* my king yet, boy. Nor would I obey that command even if you were.",  EVENT_UNIT_CHAT_MSG , 38000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//10 = 44,5s
				sEventMgr.AddEvent(TO_UNIT(Arthas), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "Then I must consider this an act of treason.", EVENT_UNIT_CHAT_MSG , 44500, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//11 = 49s
				sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "Treason?! Have you lost your mind, Arthas?", EVENT_UNIT_CHAT_MSG ,49000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//12 = 53,5s
				sEventMgr.AddEvent(TO_UNIT(Arthas), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "Have I? Lord Uther, by my right of succession and the sovereignty of my crown, I hereby relieve you of your command, and suspend your paladins from service.", EVENT_UNIT_CHAT_MSG , 53500, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//13 = 65s
				sEventMgr.AddEvent(TO_UNIT(Jaina), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "Arthas! You can't just--", EVENT_UNIT_CHAT_MSG , 65000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//14 = 67,5s
				sEventMgr.AddEvent(TO_UNIT(Arthas), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "It's done! Those of you who have the will to save this land, follow me. The rest of you... get out of my sight.", EVENT_UNIT_CHAT_MSG , 67500, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "You've just crossed a terrible threshold, Arthas.", EVENT_UNIT_CHAT_MSG , 77000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				sEventMgr.AddEvent(TO_UNIT(Arthas), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "Jaina? ", EVENT_UNIT_CHAT_MSG , 80500, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				//17 = 82s
				sEventMgr.AddEvent(TO_UNIT(Jaina), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "I'm sorry, Arthas. I can't watch you do this...", EVENT_UNIT_CHAT_MSG, 82000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
...
static LocationExtra ArthasWalk[] = 
{
	{ 0, 0, 0, 0 },
...
public:
	...
	void AIUpdate()
	{
		...
		case 1:
			{
				sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "I can only help you with a clean death.", EVENT_UNIT_CHAT_MSG , 300, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "That was just the beginning.", EVENT_UNIT_CHAT_MSG , 1000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
		...
		case 2:
			{
				...
				if( c )
				{
					...
					sEventMgr.AddEvent(TO_UNIT(c), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "As you can see, your people are now mine. I will now turn this city, household by household, until the flame of life has been snuffed out forever.", EVENT_UNIT_CHAT_MSG , 13000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					...
					//2 = 32s
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_SAY, (uint32)LANG_UNIVERSAL, "I won't allow it Mal'Ganis better than these people die by my hand than serve as your slaves in death.", EVENT_UNIT_CHAT_MSG , 32000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
