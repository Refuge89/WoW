...
{
	{ 2461.047363, -5570.428223, 415.664490, 1.735095 },
	{ 2472.961670, -5575.300781, 415.429169, 0.368502 },
	{ 2474.302246, -5576.693848, 415.394287, 1.012529 },
	{ 2480.435547, -5584.607422, 415.663696, 0.328443 },
	{ 2482.882324, -5590.556152, 415.663605, 0.383420 },
	{ 2448.824219, -5612.786621, 415.664154, 3.540719 },
	{ 2447.006104, -5611.062500, 415.664154, 4.298627 },
	{ 2440.834229, -5604.432617, 415.664154, 4.243647 },
	{ 2437.441895, -5590.024414, 415.663879, 2.822077 },
	{ 2439.216797, -5585.857422, 415.663879, 2.802442 },
};

class AcherusSoulPrison : public GameObjectAIScript
{
	public:
...
class UnworthyInitiate : public MoonScriptCreatureAI
{
	...
	//	UnworthyInitiate(Creature * c) : MoonScriptCreatureAI(c)
		...
		UnworthyInitiate(Creature * c) : MoonScriptCreatureAI(c)
		{
			AddSpell(SPELL_BLOOD_STRIKE, Target_Current, 85, 0, 4000);
			AddSpell(SPELL_DEATH_COIL, Target_Current, 85, 0, 6000);
			AddSpell(SPELL_ICY_TOUCH, Target_Current, 85, 0, 2000);
			AddSpell(SPELL_PLAGUE_STRIKE, Target_Current, 85, 0, 5000);
		}
		...
		void OnCombatStart(Unit* mTarget)
			...
			ParentClass::OnCombatStart(mTarget);// check do7me
			 }
		...
		void OnCombatStop(Unit * pTarget)
		{
			...
			ParentClass::OnCombatStart(pTarget);// check do7me
		}
...
//	uint32 summonpropid = pSpell->m_spellInfo->EffectMiscValueB[ i ];
	SummonPropertiesEntry * spe = dbcSummonProps.LookupEntryForced( pSpell->m_spellInfo->EffectMiscValue[ i ] );
	if ( !spe )
		return true;
...
//class DeathKnightInitiateGossip : public Ascent::Gossip::Script
...
bool GabedesErnters(uint32 i, Spell * pSpell)
{
	...
	uint32 summonpropid = pSpell->m_spellInfo->EffectMiscValueB[ i ];
	SummonPropertiesEntry * spe = dbcSummonProps.LookupEntryForced( pSpell->m_spellInfo->EffectMiscValueB[ i ] );
	if ( !spe )
		return true;
...
class koltira_deathweaver_AI : public MoonScriptCreatureAI
{
	public:
		MOONSCRIPT_FACTORY_FUNCTION(koltira_deathweaver_AI, MoonScriptCreatureAI);

		koltira_deathweaver_AI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
		{
	...
	public:
		...
		void AIUpdate()
		{
			...
			switch (phase)
			{
				case 1:		//Orc
					phase = 1000;	//Haxxed
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Come to finish the job, have you?", 0);
					_unit->SetStandState(STANDSTATE_STAND);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"I want to die like an orc...",  3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?",  6000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize that face anywhere... What... What have they done to you, $N?", 9000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You don't recognize me, do you? Blasted Scourge... They've tried to drain you of everything that made you a righteous force of reckoning. Every last ounce of good... Everything that made you an orc!",  12000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Think, $N. Think back. Try and remember Durotar, $Gbrother:sister;! Remember the sacrifices our heroes made so that we could be free of the blood curse. Harken back to the Valley of Trials, where we were reborn into a world without demonic influence. We found the splendor of life, $N. Together! This isn't you. You were a champion of the Horde once!",  15000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Listen to me, $N. You must fight against the Lich King's control. He is a monster that wants to see this world - our world - in ruin. Don't let him use you to accomplish his goals. You were once a hero and you can be again. Fight, damn you! Fight his control!",  18000);

					Plag = _unit->GetMapMgr()->GetInterface()->GetCreatureNearestCoords( 1371.66f , -5719.72f , 136.504f , 29053);

					Plag->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "What's going on in there? What's taking so long, $N?",  20000);
					
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. Finish me off, $N. Do it or they'll kill us both. $N... For the Horde! This world is worth saving.",  22000);
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!",  24000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.",  25000);
				...
				case 2:		//Human
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Come to finish the job, have you?",  0);
					_unit->SetStandState(STANDSTATE_STAND);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"I'd like to stand for...",  3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?",  8000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize that face anywhere... What... What have they done to you, $N?", 10000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You don't remember me, do you? Blasted Scourge...They've tried to drain of everything that made you a righteous force of reckoning. Every last ounce of good...Everything that made you a human!",  15000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Think, $N. Think back. Try and remember the hills and valleys of Elwynn, where you were born. Remember the splendor of life, $Gbrother:sister;. You were a champion of the Alliance once! This isn't you.", 19000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Listen to me, $N. You must fight against the Lich King's control. He is a monster that wants to see this world - our world - in ruin. Don't let him use you to accomplish his goals. You were once a hero and you can be again. Fight, damn you! Fight his control!", 22000);

					Plag = _unit->GetMapMgr()->GetInterface()->GetCreatureNearestCoords( 1371.66f , -5719.72f , 136.504f , 29053);

					Plag->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "What's going on in there? What's taking so long, $N?",  26000);
					
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. FInish me off, $N. Do it or they'll kill us both. $N...Remember Elwynn. This world is worth saving.", 29000);
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!", 32000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.", 35000);
				...
				case 3:		//Dwarf
					...
					phase = 1000;//Haxxed
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Come to finish the job, have ye", 0);
					_unit->SetStandState(STANDSTATE_STAND);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Well this son o' Ironforge would like...", 3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?" ,6000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize that face anywhere... What... What have they done to ye, $Glad:lass;?", 9000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Ye don't remember me, do ye? Blasted Scourge... They've tried to drain ye o' everything that made ye a righteous force o' reckoning. Every last ounce o' good... Everything that made you a $Gson:daughter; of Ironforge!", 12000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Think, $N. Think back. Try and remember the snow capped mountains o' Dun Morogh! Ye were born there, $Glad:lass;. Remember the splendor o' life, $N! Ye were a champion o' the dwarves once! This isn't ye!",  15000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Listen to me, $N Ye must fight against the Lich King's control. He's a monster that wants to see this world - our world - in ruin. Don't let him use ye to accomplish his goals. Ye were once a hero and ye can be again. Fight, damn ye! Fight his control!",  18000);

					Plag = _unit->GetMapMgr()->GetInterface()->GetCreatureNearestCoords( 1371.66f , -5719.72f , 136.504f , 29053);

					Plag->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "What's going on in there? What's taking so long, $N?",20000);
					
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. Finish me off, $N. Do it or they'll kill us both $N... For KHAAAAAAAAZZZ MODAAAAAANNNNNN!!!", 22000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SetStandState,(uint8)STANDSTATE_KNEEL , EVENT_CREATURE_UPDATE, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!", 24000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.", 25000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::setDeathState ,(JUST_DIED) , EVENT_CREATURE_UPDATE, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				case 4:		//Nightelf
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"I'd like to stand for...", 3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?" ,6000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize that face anywhere... What... What have they done to you, $N?", 12000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You don't remember me? When you were a child your mother would leave you in my care while she served at the Temple of the Moon. I held you in my arms and fed you with honey and sheep's milk to calm you until she would return. You were my little angel. Blasted Scourge... What have they done to you, $N?", 15000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You must remember the splendor of life, $Gbrother:sister;. You were a champion of the Kaldorei once! This isn't you!", 18000);
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. Finish me off, $N. Do it or they'll kill us both. $N... Remember Teldrassil, our beloved home. This world is worth saving.", 22000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SetStandState,(uint8)STANDSTATE_KNEEL , EVENT_CREATURE_UPDATE, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!", 24000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.",  25000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::setDeathState ,(JUST_DIED) , EVENT_CREATURE_UPDATE, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				case 5:		//Undead
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Come to finish the job, have you?", 0);
					_unit->SetStandState(STANDSTATE_STAND);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Ironic, isn't it? To be killed...", 3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?", 4000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize that decay anywhere... What... What have they done to you, $N?" , 6000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You don't remember me, do you? We were humans once - long, long ago - until Lordaeron fell to the Scourge. Your transformation to a Scourge zombie came shortly after my own. Not long after that, our minds were freed by the Dark Lady.",  9000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"A pact was made, $Gbrother:sister;! We vowed vengeance against the Lich King! For what he had done to us! We battled the Scourge as Forsaken, pushing them back into the plaguelands and freeing Tirisfal! You and I were champions of the Forsaken!",  13000);
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. Finish me off, $N. Do it or they'll kill us both. $N... Remember Tirisfal! This world is worth saving!",  22000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SetStandState,(uint8)STANDSTATE_KNEEL , EVENT_CREATURE_UPDATE, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!",  24000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.",  25000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::setDeathState ,(JUST_DIED) , EVENT_CREATURE_UPDATE, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				case 6:		//Tauren
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Come to finish the job, have you?", 0);
					_unit->SetStandState(STANDSTATE_STAND);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You'll look me in the eyes when...",  3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?", 4000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize those horns anywhere... What have they done to you, $N?" , 6000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You don't remember me, do you? Blasted Scourge... They've tried to drain you of everything that made you a righteous force of reckoning. Every last ounce of good... Everything that made you a tauren!",  9000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Think, $N. Think back. Try and remember the rolling plains of Mulgore, where you were born. Remember the splendor of life, $Gbrother:sister;. You were a champion of the tauren once! This isn't you.",  13000);
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. Finish me off, $N. Do it or they'll kill us both. $N... Remember Mulgore. This world is worth saving.",  22000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SetStandState,(uint8)STANDSTATE_KNEEL , EVENT_CREATURE_UPDATE, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!",  24000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.",  25000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::setDeathState ,(JUST_DIED) , EVENT_CREATURE_UPDATE, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				case 7:		//Gnome
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Come to finish the job, have you?", 0);
					_unit->SetStandState(STANDSTATE_STAND);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"If you'd allow me just one...",  3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?", 3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize that face anywhere... What... What have they done to you, $N?" ,6000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You don't remember me, do you? Blasted Scourge... They've tried to drain you of everything that made you a pint-sized force of reckoning. Every last ounce of good... Everything that made you a gnome!",  9000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Think, $N. Think back. Try and remember Gnomeregan before those damned troggs! Remember the feel of an [arclight spanner] $Gbrother:sister;. You were a champion of gnome-kind once! This isn't you.",  13000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Listen to me, $N. You must fight against the Lich King's control. He is a monster that wants to see this world - our world - in ruin. Don't let him use you to accomplish his goals. You were once a hero and you can be again. Fight, damn you! Fight his control!",  16000);
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. Finish me off, $N. Do it or they'll kill us both. $N... Remember Gnomeregan! This world is worth saving.", 22000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SetStandState,(uint8)STANDSTATE_KNEEL , EVENT_CREATURE_UPDATE, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!", 24000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.", 25000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::setDeathState ,(JUST_DIED) , EVENT_CREATURE_UPDATE, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				case 8:			//Troll
						...
						phase = 1000;//Haxxed
						_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Come ta finish da job, mon?",  0);
						_unit->SetStandState(STANDSTATE_STAND);
                        _unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Dis troll gonna stand for da...", 3000);
                        _unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N? Mon?", 4000);
                        _unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize dem tusks anywhere... What... What have dey done ta you, mon?" , 6000);
                        _unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You don't remember me, mon? Damn da Scourge! Dey gone ta drain you of everytin dat made ya a mojo masta. Every last ounce of good... Everytin' dat made ya a troll hero, mon!", 9000);
                        _unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"TINK $N. Tink back, mon! We be Darkspear, mon! Bruddas and sistas! Remember when we fought the Zalazane and done took he head and freed da Echo Isles? MON! TINK! You was a champion of da Darkspear trolls!", 13000);
						_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Listen ta me, $Gbrudda:sista;. You must fight against da Lich King's control. He be a monstar dat want ta see dis world - our world - be ruined. Don't let he use you ta accomplish he goals. You be a hero once and you be a hero again! Fight it, mon! Fight he control!", 16000);

						Plag = _unit->GetMapMgr()->GetInterface()->GetCreatureNearestCoords( 1371.66f , -5719.72f , 136.504f , 29053);

						Plag->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL, "What's going on in there? What's taking so long, $N?",  20000);
						
						_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Der... Der's no more time for me. I be done for. Finish me off $N. Do it or they'll kill us both. $N... Remember Sen'jin Village, mon! Dis world be worth saving!", 22000);
						sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SetStandState,(uint8)STANDSTATE_KNEEL , EVENT_CREATURE_UPDATE, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
						_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!",  24000);
                        _unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.",  25000);
						sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::setDeathState ,(JUST_DIED) , EVENT_CREATURE_UPDATE, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				case 9:		//Bloodelf
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?",  4000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize that face anywhere... What... What have they done to you, $N?" ,6000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Think, $N. Think back. Try and remember the majestic halls of Silvermoon City, where you were born. Remember the splendor of life, $Gbrother:sister;. You were a champion of the sin'dorei once! This isn't you.",  9000);
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. Finish me off, $N. Do it or they'll kill us both. $N... Remember Silvermoon. This world is worth saving!", 22000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SetStandState,(uint8)STANDSTATE_KNEEL , EVENT_CREATURE_UPDATE, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!",  24000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.", 25000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::setDeathState ,(JUST_DIED) , EVENT_CREATURE_UPDATE, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
				...
				case 10:		//Drenai
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You'll look me in the eyes when...", 3000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N?", 4000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"$N, I'd recognize those face tentacles anywhere... What... What have they done to you, $N?" ,6000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"You don't remember me, do you? Blasted Scourge... They've tried to drain you of everything that made you a righteous force of reckoning. Every last ounce of good... Everything that made you a draenei!",  9000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Think, $N. Think back. Try and remember the proud mountains of Argus, where you were born. Remember the splendor of life, $Gbrother:sister;. You were a champion of the draenei once! This isn't you.", 12000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Listen to me, $N. You must fight against the Lich King's control. He is a monster that wants to see this world - our world - in ruin. Don't let him use you to accomplish his goals. You were once a hero and you can be again. Fight, damn you! Fight his control!", 16000);
					...
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"There... There's no more time for me. I'm done for. Finish me off, $N. Do it or they'll kill us both. $N... Remember Argus. Don't let that happen to this world.", 22000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::SetStandState,(uint8)STANDSTATE_KNEEL , EVENT_CREATURE_UPDATE, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"Do it, $N! Put me out of my misery!",  24000);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,"%s dies from his wounds.",  25000);
					sEventMgr.AddEvent(TO_UNIT(_unit), &Unit::setDeathState ,(JUST_DIED) , EVENT_CREATURE_UPDATE, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
...
class Conversation_1 : public QuestScript
{
	public:
		...
		{
			//Plr->SetFaction(2089);
			Plr->SetUInt32Value(UNIT_FIELD_FACTIONTEMPLATE, 2089);
		...
		{
			//Plr->SetFaction(35);
			Plr->SetUInt32Value(UNIT_FIELD_FACTIONTEMPLATE, 35);
		}
};
...
class Conversation_2 : public QuestScript
{
	public:
		...
		{
			//Plr->SetFaction(2051);
			Plr->SetUInt32Value(UNIT_FIELD_FACTIONTEMPLATE, 2051);
			Plr->DeMorph();
		}
};
...
class CitizenAI : public MoonScriptCreatureAI
{
	...
	void OnCombatStart(Unit * mTarget)
	{
		...
		if(Rand(chance) && mTarget->GetTypeId() == TYPEID_PLAYER)
		{
			...
			//_unit->GetAIInterface()->WipeHateList(); /// could be 7l
			_unit->GetAIInterface()->WipeHateList();
			//_unit->SetEmoteState(431);
			//_unit->SetStandState(431);
...
public:
	void GossipHello(Object* pObject, Player * plr, bool AutoSend)
	{
		if( plr->GetQuestLogForEntry(12687) ) // doesnt need check if player have this aura, as Salanar is not visible if player has this aura
		{
			GossipMenu * Menu;
			objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), 13355, plr);
