...
namespace Ascent
{
    ...
    {
        cpu_count = Ascent::SysInfo::GetCPUCount();
        last_update = Ascent::SysInfo::GetTickCount();
        last_cpu_usage = Ascent::SysInfo::GetCPUUsage();
    }

    float PerformanceCounter::GetCurrentRAMUsage()
    {
        unsigned long long usage = Ascent::SysInfo::GetRAMUsage();
    ...
    {
        unsigned long long now = Ascent::SysInfo::GetTickCount();
        unsigned long long now_cpu_usage = Ascent::SysInfo::GetCPUUsage();
