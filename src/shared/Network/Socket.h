...
public:
    ...
    ASCENT_INLINE bool IsDeleted()
    {
        return m_deleted.GetVal();
    }
    ASCENT_INLINE bool IsConnected()
    {
...
protected:
    ...
    Ascent::Threading::AtomicBoolean m_connected;

    // We are deleted? Stop us from posting events.
    Ascent::Threading::AtomicBoolean m_deleted;
...
public:
    ...
    ASCENT_INLINE void IncSendLock() { ++m_writeLock; }
    ASCENT_INLINE void DecSendLock() { --m_writeLock; }
...
private:
    ...
    Ascent::Threading::AtomicCounter m_writeLock;
...
public:
    ...
    ASCENT_INLINE bool HasSendLock()
    {
        bool res;
